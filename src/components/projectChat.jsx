...
const recommerce = [
    ...
    "I helped the team deliver improvement to the customer experience to achieve both growth and business sustainability, designed a fashion recycling service and moderated product strategy workshops. Are you interested in reading detailed case studies from my past work?"
]
...
const babbel = [
    ...
    "I wrote my master thesis on redesigning tools for expert or novice users. It turns out that is especially hard for expert users to adapt to new systems! Are you interested in reading detailed case studies from my past work?"
]
...
const freelance = [
    ...
    "Currenlty, I am working with The Mentor Exchange, as a member of the founding team focusing mostly on user research, service design and branding. Are you interested in reading detailed case studies from my past work?"
]
                    ...
                    {strings[position].map((string, i) => {
                        ...
                        <motion.div
                            ...
                            <motion.div
                                ...
                                <span> </span>
                                {
                                    i > 0 && <span className="clickable" onClick={() => handlePortfolioClick()}>Click here.</span>
                                }
                            </motion.div>
                            <motion.div
