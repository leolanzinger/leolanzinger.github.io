...
The **quantitative tests** results showed that users were faster when interacting with one hand, however more precision was reached when interacting with two hands. Volume parameter control though did not report significant differences between the two prototypes.
